...
app: blank
generated: "2026-06-17T20:37:35.158Z"
---
...
- **Field Types** including short and long text, email, phone, URL, number, single and multi select, dropdown, date, time, rating, scale, NPS, checkbox, toggle, file upload, section header, paragraph, and hidden fields
...
- **Multi-Page Forms** that group fields by page number, with Back and Next controls and a progress bar
