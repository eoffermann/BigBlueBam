...
| 2 | Rebuild mis-configured Bolt templates (+ agent-in-loop audit) | Bolt | rework + audit | ⏳ agent | — |
| 3 | "Add many" channels via right-click on "+" | Banter | feature | ⏳ agent | — |
| 4 | Analytics → black screen | Bond | bug | ⏳ agent | — |
| 5 | SMTP settings placeholder → role-aware guidance | Blast | UX fix | ✅ done | `8ec24a02` |
| 6 | Default "Bureau" metrics not tracking real activity | Bench | bug/data | ⏳ agent | — |
...
### 2. Bolt templates — ⏳ (agent implementing)
...
### 3. Banter "Add many" — ⏳ (agent implementing)
...
### 4. Bond Analytics — ⏳ (agent implementing)
...
### 6. Bench/Bureau metrics — ⏳ (agent implementing)
