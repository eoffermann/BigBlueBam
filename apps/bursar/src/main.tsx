...
// --- Bureau-client mount --------------------------------------------------
// The suite-wide LiveKit docked-box widget: presence, knocks, and cross-app teleport. Mirrors
// apps/burn/src/main.tsx exactly, including the pushState/replaceState/popstate wiring so the
// widget follows in-app navigation.
function describeLocation(): LocationDescriptor | undefined {
  const path = window.location.pathname;
  if (!path.startsWith('/bursar')) return undefined;
  return {
...
try {
  ...
  console.warn('[bursar] mountBureauClient failed', err);
}
