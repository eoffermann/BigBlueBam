...
initSystemErrorReporter({ service: 'bearing' });
import { App } from './app';
...
// Bearing shares Bam's session and reads /b3/api/auth/me directly.
...
try {
  ...
  console.warn('[bearing] mountBureauClient failed', err);
}
