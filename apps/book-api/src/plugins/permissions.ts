// Wave D Phase 3: per-action permission enforcement for book-api.
//
...
const bookPermissionsPlugin = fp(
  async (fastify: FastifyInstance) => {
    ...
    fastify.log.info({ mode: env.BBB_PERMISSIONS_ENFORCE }, 'book-api permissions plugin registered');
  },
  { name: 'book-permissions', dependencies: ['auth'] },
);

export default bookPermissionsPlugin;
