// Per-action permission enforcement for basis-api.
//
...
// Mirrors apps/bench-api/src/plugins/permissions.ts; the resolver call goes
...
const basisPermissionsPlugin = fp(
  async (fastify: FastifyInstance) => {
    ...
    fastify.log.info(
      { mode: env.BBB_PERMISSIONS_ENFORCE },
      'basis-api permissions plugin registered',
    );
  },
  { name: 'basis-permissions', dependencies: ['auth'] },
);

export default basisPermissionsPlugin;
