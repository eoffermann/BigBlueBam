...
// Local Drizzle view of the shared agent_proposals table (migration 0128). Burn inserts
// change-order and Bill line-item drafts directly with approver_id=NULL (spec 4.6). Note org_id, not
