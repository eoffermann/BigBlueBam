...
initSystemErrorReporter({ service: 'bay' });
import { App } from './app';
...
// Bay shares Bam's session and reads /b3/api/auth/me directly.
...
function describeLocation(): LocationDescriptor | undefined {
  ...
  if (!path.startsWith('/bay')) return undefined;
  return {
...
try {
  ...
  console.warn('[bay] mountBureauClient failed', err);
}
