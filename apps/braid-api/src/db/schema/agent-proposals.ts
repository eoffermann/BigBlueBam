...
// Local Drizzle view of the shared agent_proposals table (migration 0128). Braid inserts
// review-band candidates directly with approver_id=NULL (spec 2.2). Note org_id, not
