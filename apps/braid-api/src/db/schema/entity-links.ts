...
// Local Drizzle view of the shared entity_links table (migration 0132). Braid is the
// first satellite to write it directly (braid.profile -> <source_type> links, spec 7.2).
