// Per-action permission enforcement for braid-api.
//
...
const braidPermissionsPlugin = fp(
  async (fastify: FastifyInstance) => {
    ...
    fastify.log.info(
      { mode: env.BBB_PERMISSIONS_ENFORCE },
      'braid-api permissions plugin registered',
    );
  },
  { name: 'braid-permissions', dependencies: ['auth'] },
);

export default braidPermissionsPlugin;
