// Wave D Phase 3: per-action permission enforcement for board-api.
//
...
const boardPermissionsPlugin = fp(
  async (fastify: FastifyInstance) => {
    ...
    fastify.log.info({ mode: env.BBB_PERMISSIONS_ENFORCE }, 'board-api permissions plugin registered');
  },
  { name: 'board-permissions', dependencies: ['auth'] },
);

export default boardPermissionsPlugin;
