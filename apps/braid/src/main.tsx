...
initSystemErrorReporter({ service: 'braid' });
import { App } from './app';
...
// Braid shares Bam's session and reads /b3/api/auth/me directly.
...
function describeLocation(): LocationDescriptor | undefined {
  ...
  if (!path.startsWith('/braid')) return undefined;
  return {
...
try {
  ...
  console.warn('[braid] mountBureauClient failed', err);
}
