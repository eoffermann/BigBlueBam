...
const navItems = [{ label: 'Asset Library', icon: Database, path: '/', page: 'assets' }];

export function BinSidebar({ onNavigate, activePage }: BinSidebarProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2 px-4 h-14 shrink-0">
        ...
        <span className="text-sm font-semibold text-white">Bin</span>
      </div>
